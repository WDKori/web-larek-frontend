...
/*** Валидация  строк "address" и payment ***/
...
/*** Открытие модального окна "Почта" и "Телефон" ***/
